...
RUNTIME_TORRC="/run/tor/auth-torrc"

umask 077
mkdir -p /run/tor /var/lib/tor /var/lib/tor/auth_hidden_service
chmod 700 /run/tor /var/lib/tor /var/lib/tor/auth_hidden_service
