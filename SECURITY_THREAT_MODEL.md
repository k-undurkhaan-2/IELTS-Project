...
- Bypassing `data-manage` proof/callback binding for explicit practice-record import, single-record delete, or full clear, especially if a proof from one browser can be replayed into a different business session.
