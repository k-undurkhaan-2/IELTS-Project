...
- Bypassing `data-manage` proof/callback binding for explicit practice-record import, single-record delete, full clear, or backup restore, especially if a proof from one browser can be replayed into a different business session.
